...
if(latexcode!=null){
  ...
  var batchfile=new File(temppath+'/latex2illustrator.sh');
  if(batchfile.exists){
  batchfile.open("w");
  batchfile.writeln("pdflatex"+' -aux-directory="'+temppath+'" -include-directory="'+temppath+'" -output-directory="'+temppath+'" "'+temppath+'/latex2illustrator.tex"');
